const quizData = [
    ...
    },
    {
        ...
        correct: 0,
        image: ["pics/パウバート.exif", "pics/パウバート２.exif", "pics/パウバート３.exif"]
    },
    {
    ...
    {
        question: "受付（うけつけ）の クロウハウザーさんは、なにを 食べる（たべる）のが いちばん 大好き（だいすき）かな？🍩",
        choices: ["ドーナツ", "にんじん", "アイスクリーム", "おにぎり", "チョコ", "クッキー"],
        correct: 0,
        image: ["pics/クロウハウザー.exif", "pics/クロウハウザー2.exif"]
    },
    {
        question: "ズートピアは、どんな 街（まち）かな？🌿",
        choices: ["いろんな 動物（どうぶつ）が なかよく 住（す）んでいる 街（まち）", "クマだけが いる 街（まち）", "サカナだけの 街（まち）", "トリだけの 街（まち）", "オバケの 街", "なにもない 街"],
        correct: 0,
        image: "pics/ガゼル.exif"
    },
    {
        question: "ボゴ 署長（しょちょう）さんは、なんの 動物（どうぶつ）かな？💪",
        choices: ["スイギュウ（おおきな うし）", "キツネ", "ウサギ", "トラ", "ライオン", "カバ"],
        correct: 0,
        image: ["pics/ボゴ.exif", "pics/ボゴ２.exif"]
    },
    {
        question: "ジュディが 小さい（ちいさい） ころから 夢見（ゆめみ）ていた、かっこいい お仕事（しごと）は なあに？👮‍♀️",
        choices: ["警察官（けいさつかん）", "ケーキ屋さん", "歌（うた）を うたう 人（ひと）", "お医者（いしゃ）さん", "おはなやさん", "パンやさん"],
        correct: 0,
        image: ["pics/ホップス.exif", "pics/ホップス２.exif"]
    },
    {
        question: "キツネの ニックの 毛（け）の色（いろ）は、なに色（いろ）かな？🦊",
        choices: ["オレンジ", "あお", "あか", "くろ", "みどり", "しろ"],
        correct: 0,
        image: ["pics/ワイルド.exif", "pics/ワイルド２.exif"]
    },
    {
        question: "ズートピア２に 出（で）てくる ヘビの ゲイリーの 色（いろ）は、どんな 感じ（かんじ）？🐍",
        choices: ["みどりっぽい", "ピンク", "くろ", "あお", "きいろ", "しろ"],
        correct: 0
    },
    {
        question: "「マシュ・マーケット」という 新（あたら）しい 場所（ばしょ）は、どんな ところかな？🌊",
        choices: ["お水（みず）の中（なか）の 街（まち）", "お山（やま）の上（うえ）", "さばくの中（なか）", "森（もり）の中（なか）", "宇宙", "おかしのくに"],
        correct: 0
    },
    {
        question: "ジュディが 田舎（いなか）から ズートピアに 行（い）くときに 乗（の）ったのは なあに？🚆",
        choices: ["れっしゃ（でんしゃ）", "ひこうき", "おふね", "バス", "くるま", "じてんしゃ"],
        correct: 0
    },
    {
        question: "ジュディと ニックは、さいごは どうなるかな？🤝",
        choices: ["仲良し（なかよし）に なる", "けんかしたまま", "会（あ）わなく なる", "ライバルに なる", "わすれちゃう", "おわかれする"],
        correct: 0
    },
    {
        question: "ジュディの お耳（みみ）は、どんな お耳（みみ）かな？🐰",
        choices: ["ながくて ピョコピョコ 動（うご）く", "みじかくて まんまる", "とんがっている", "お耳（みみ）が ない", "とっても ちいさい", "ぞうさん みたい"],
        correct: 0,
        image: ["pics/ホップス.exif", "pics/ホップス２.exif"]
    },
    {
        question: "新（あたら）しい 冒険（ぼうけん）も、ニックと ジュディは いっしょに 行（い）くかな？🌟",
        choices: ["いっしょに 行（い）く！", "ひとりで 行（い）く", "べつべつに 行（い）く", "お留守番（るすばん）する", "いかない", "まだ わからない"],
        correct: 0
    },
    {
        question: "ズートピア２に 出（で）てくる アザラシさんは、どこに いるかな？❄️",
        choices: ["お水（みず）の中（なか）", "お空（そら）の上（うえ）", "火（ひ）の中（なか）", "宇宙（うちゅう）", "おうちの中", "がっこう"],
        correct: 0
    },
    {
        question: "ニックの しっぽは、どんな 形（かたち）かな？✨",
        choices: ["フサフサしている", "つるつるしている", "トゲトゲしている", "とっても 短（みじか）い", "かたい", "まるい"],
        correct: 0,
        image: ["pics/ワイルド.exif", "pics/ワイルド２.exif"]
    },
    {
        question: "ズートピアの 街（まち）には、もっと たくさんの 動物（どうぶつ）が 来（く）るかな？🐘",
        choices: ["来（く）るよ！", "こないよ", "へっちゃうよ", "誰（だれ）も いなく なる", "わすれちゃうよ", "おやすみするよ"],
        correct: 0
    },
    {
        question: "ズートピア２も、ワクワクする 冒険（ぼうけん）に なるかな？🎬",
        choices: ["もちろん、なる！", "ねむく なる", "かなしく なる", "おこりたく なる", "つまらなく なる", "ふつう"],
        correct: 0
    },
    {
        question: "ズートピア２の 主題歌（しゅだいか）（うた）の 名前（なまえ）は？🎶",
        choices: ["Zoo 〜君（きみ）が いるから〜", "トライ・エヴリシング", "ハッピー・ソング", "ズートピア・マーチ", "あしたへ ジャンプ", "Zoo"],
        correct: 0,
        image: "pics/ガゼル.exif"
    }
];
